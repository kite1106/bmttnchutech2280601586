...
previus_block = my_blockchain.get_previous_block()
previus_proof = previus_block.proof
new_proof = my_blockchain.proof_of_work(previus_proof)
previus_hash = previus_block.hash
my_blockchain.add_transaction('Genesis','Miner',1)
new_block = my_blockchain.create_block(new_proof,previus_hash)
